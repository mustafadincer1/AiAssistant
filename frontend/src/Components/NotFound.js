...
function NotFound() {
  return (
    <main className="grid min-h-screen w-full place-items-center  bg-gray-100 px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        <p className="font-semibold text-indigo-600 text-xl">404</p>
